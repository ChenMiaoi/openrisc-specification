...
ASCIIDOCTOR_PDF := $(ENV) bundle exec asciidoctor-pdf
ASCIIDOCTOR_HTML := $(ENV) bundle exec asciidoctor
ASCIIDOCTOR_EPUB := $(ENV) bundle exec asciidoctor-epub3
ASCIIDOCTOR_TAGS := $(ENV) bundle exec asciidoctor --backend tags --require=./docs-resources/converters/tags.rb
